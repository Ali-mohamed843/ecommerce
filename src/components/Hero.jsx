...
const Hero = () => {
  ...
  return (
    <section className="py-20 px-4 mt-20 md:px-12" dir={isArabic ? "rtl" : "ltr"}>
      <div className={`max-w-7xl mx-auto flex flex-col-reverse ${isArabic ? "md:flex-row-reverse" : "md:flex-row"} items-center gap-10`}>
