...
const ProductDetails = () => {
  ...
  const translatedTitle = isArabic ? product.ar?.title || arTitles[productId] || product.title : product.title;
  const translatedDescription = isArabic ? product.ar?.description || arDescriptions[productId] || product.description : product.description;
              ...
              <div className="flex items-center gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <button
                    ...
                    className={`text-3xl transition-all duration-200 ${(hover || rating) >= star ? 'text-yellow-400' : 'text-gray-300'
